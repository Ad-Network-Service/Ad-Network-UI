    ...
    <div className="card shadow-lg ">
      ...
      <div className="card-body pt-sm-3 pt-0">
        ...
        <a href="javascript:void(0)" className="switch-trigger background-color">
          <div className="badge-colors my-2 text-start">
            <span className="badge filter bg-gradient-primary active" data-color="primary"
              onClick={click()}></span>
            <span className="badge filter bg-gradient-dark" data-color="dark" onClick={click()}></span>
            <span className="badge filter bg-gradient-info" data-color="info" onClick={click()}></span>
            <span className="badge filter bg-gradient-success" data-color="success" onClick={click()}></span>
            <span className="badge filter bg-gradient-warning" data-color="warning" onClick={click()}></span>
            <span className="badge filter bg-gradient-danger" data-color="danger" onClick={click()}></span>
          </div>
        </a>
        ...
        <div className="d-flex">
          <button className="btn bg-gradient-primary w-100 px-3 mb-2 active"
            onClick={click()}>Transparent</button>
          <button className="btn bg-gradient-primary w-100 px-3 mb-2 ms-2" 
            onClick={click()}>White</button>
        </div>
        ...
        <div className="form-check form-switch ps-0">
          <input className="form-check-input mt-1 ms-auto" type="checkbox" id="navbarFixed" onClick={click()}/>
        </div>
