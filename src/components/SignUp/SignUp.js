export const SignUp = () => (
    ...
    <section className="min-vh-100 mb-8">
      <div className="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style={{backgroundImage: "url('/Img/curved-images/curved6.jpg')"}}>
            ...
            <div className="card z-index-0">
              ...
              <div className="card-body">
                <form role="form text-left" method="post">
                  <div className="mb-3">
                    <input type="text" className="form-control" id="user" placeholder="Name" aria-label="Name" aria-describedby="email-addon"/>
                  </div>
                  <div className="mb-3">
                    <input type="email" className="form-control" placeholder="Email" id="email" aria-label="Email" aria-describedby="email-addon"/>
                  </div>
                  <div className="mb-3">
                    <input type="password" className="form-control" id="pd" placeholder="Password" aria-label="Password" aria-describedby="password-addon"/>
                  </div>
                  ...
                  <div className="text-center">
                    <input type="button" className="btn bg-gradient-dark w-100 my-4 mb-2" onclick="signUp()" value="Sign Up"/>
                  </div>
                  <p className="text-sm mt-3 mb-0">Already have an account? <a href="/login" classNameName="text-dark font-weight-bolder" >Sign in</a></p>
                </form>
              </div>
            </div>
          </div>
