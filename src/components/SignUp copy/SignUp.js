              ...
              <div className="col-xl-4 col-lg-5 col-md-7 mx-auto">
                <div className="card z-index-0">
                  ...
                  <div className="card-body">
                    <form role="form text-left" onSubmit={registerUser}>
                      <div className="mb-3">
                        <input 
                          type="email" 
                      ...
                      <p className="text-sm mt-3 mb-0">Already have an account? <Link to="/login"><span className="text-dark font-weight-bolder" >Sign in</span></Link></p>
                    </form>
                  </div>
                </div>
              </div>
