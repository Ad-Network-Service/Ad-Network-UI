            ...
            <div className="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div className="card card-plain mt-8">
                <div className="card-header pb-0 text-left bg-transparent">
                  <h3 className="font-weight-bolder text-info text-gradient">Please verify Email</h3>
                  <p className="mb-0">A verification link has been sent to your given email address please check your inbox </p>
                </div>
                <div className="card-body">
                  <form role="form">
                    ...
                    <div className="text-center">
                      <input type="button" className="btn bg-gradient-info w-100 mt-4 mb-0" onclick="login()" value="Re-send Mail"/>
